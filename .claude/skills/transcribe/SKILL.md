...
- **Встраивать изображения** из манифеста (Step 1а) на правильные позиции: `![[image.png]]`
  - Для страничных PNG (`-pageN.png`): встроить там, где в тексте появляется "Figure N" / "Рис. N"
  - Для отдельных фигур (`-pN-imgM.png`): встроить рядом с их подписью
