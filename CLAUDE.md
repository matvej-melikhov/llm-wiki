...
Скрипты в `bin/` (`embed.py`, `lint.py`, `transcribe.py`, `knowledge_map.py`, `gen_dashboards.py`, `gen_index.py`, `rename_wiki_page.py`, setup) — пользовательский код, в таблице vault не учитываются.
