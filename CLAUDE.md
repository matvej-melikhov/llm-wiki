...
**Скиллы:** `/wiki`, `/ingest`, `/query`, `/lint`, `/save`, `/brainstorm`, `/kn-map`, `/transcribe`, `/defuddle`, `/obsidian-bases`, `/obsidian-markdown`
...
| `raw/brainstorm/` | Транскрипты brainstorm-сессий (источники, рождённые в диалоге) | `brainstorm` | create |
...
| `wiki/minds/` | Авторские мысли пользователя (через `/brainstorm`) | `brainstorm` | create + edit |
